(function () {
    ...
    angular
        .module('mainApp')
        .controller('followedCourtsCtrl', ['$scope', '$uibModal', '$document', 'settings', 'httpService', 'commonServices', '$timeout', 'courtContext', courtCtrl]);
    ...
    function courtCtrl($scope, $uibModal, $document, settings, httpService, commonServices, $timeout, courtContext) {
		...
		$scope.imageUploadPath = settings.imageUploadPath;
